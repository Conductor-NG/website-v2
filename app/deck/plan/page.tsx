...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px">
  ...
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:auto">
    <div style="min-width:900px;font-size:15px;line-height:1.35">
      ...
      <div style="display:grid;grid-template-columns:1.6fr repeat(6,1fr);padding:14px 24px;border-bottom:1px solid #ECDFCE;text-align:center;align-items:center"><strong style="text-align:left">Present in Lagos</strong><span style="color:#24A148;font-weight:700">Sep 15</span><span>Yes</span><span>Yes</span><span style="color:#8A7A6B">Sep 25</span><span>Yes</span><span style="color:#C41818">Exiting</span></div>
  ...
  <p style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:24px;line-height:1.3;color:#6B5D4E;margin:0;max-width:900px">The first affordable, recurring carpool in Lagos — live ten days before Shuttlers POD, in the only city Uber just left. Two serious entrants now; we are first, cheapest, and the only weekly-recurring one.</p>
</section>
