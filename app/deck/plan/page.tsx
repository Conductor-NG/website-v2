...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 72px;width:100%;box-sizing:border-box">
  <div style="position:relative;display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:24px">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;border-top:2px solid #EE4643;padding-top:20px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:30px;line-height:1;color:#EE4643">Sep 14, 2026</div><p style="font-size:15px;line-height:1.5;margin:0;font-weight:700">Paid rides launch on the Lagos Island cluster.</p></div>
    <div style="display:flex;flex-direction:column;gap:14px;border-top:2px dashed #D6C3B3;padding-top:20px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:30px;line-height:1;color:#6B5D4E">By end 2027</div><p style="font-size:15px;line-height:1.5;color:#514336;margin:0">10,000+ car owners · 25,000+ passengers · Conductor for Enterprise live · Deliveries public · Series A conversation</p></div>
  </div>
</section>
  ...
  <div style="max-width:1200px;margin:0 auto;padding:72px 32px;display:flex;flex-direction:column;gap:32px">
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1fr) min(240px,42vw) min(240px,42vw);gap:24px;align-items:start">
      <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <div style="border:1px solid #ECDFCE;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:8px"><div style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#EE4643">Phase 2 · Dec 2026–Feb 2027</div><div style="font-size:22px;font-weight:700">Conductor for Enterprise</div><p style="font-size:15px;line-height:1.5;color:#514336;margin:0">Sell to Island HQs — banks, telcos, consulting firms with 500+ staff. Onboard their employees, match coworkers, employer subsidises the fee as a benefit. Guaranteed density and trust. LOIs already in progress.</p></div>
...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px">
  ...
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:auto">
    <div style="min-width:900px;font-size:15px;line-height:1.35">
      ...
      <div style="display:grid;grid-template-columns:1.6fr repeat(6,1fr);padding:14px 24px;border-bottom:1px solid #ECDFCE;text-align:center;align-items:center"><strong style="text-align:left">Present in Lagos</strong><span style="color:#24A148;font-weight:700">Sep 14</span><span>Yes</span><span>Yes</span><span style="color:#8A7A6B">Sep 25</span><span>Yes</span><span style="color:#C41818">Exiting</span></div>
  ...
  <p style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:24px;line-height:1.3;color:#6B5D4E;margin:0;max-width:900px">The first affordable, recurring carpool in Lagos — live eleven days before Shuttlers POD, in the only city Uber just left. Two serious entrants now; we are first, cheapest, and the only weekly-recurring one.</p>
</section>
