...
<section style="max-width:1200px;margin:0 auto;padding:80px 32px 48px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:16px">
  ...
  <p style="font-size:18px;line-height:1.55;color:#514336;margin:0;max-width:840px">We are not a hired-in team — we are friends, and friends of friends. That is how a group this size has kept building and supporting the app for 30+ months — on founder-funded salaries, with most taking part of their market rate as ownership rather than cash. 20+ contributors across engineering, product, design, operations, marketing and QA, in Lagos, London and Canada, with every part of the stack built in-house.</p>
</section>
...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 56px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:20px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
    <a href="/deck/team/wale" style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px;text-decoration:none;color:inherit"><div style="width:120px;height:120px;border-radius:50%;overflow:hidden;background:#FAE8CF;flex:none"><img src="/deck/images/founder-wale.jpg" alt="Wale Shekoni" style="width:100%;height:100%;object-fit:cover;object-position:50% 22%;display:block"></div><div><div style="font-size:24px;font-weight:700">Wale Shekoni</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Founder</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">Watched Lagos commuters flag him down for rides he had no safe way to give — and built Conductor to fix it.</p><span style="font-size:14px;font-weight:700;color:#EE4643;margin-top:auto">View profile →</span></a>
    <a href="/deck/team/dimeji" style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px;text-decoration:none;color:inherit"><div style="width:120px;height:120px;border-radius:50%;overflow:hidden;background:#FAE8CF;flex:none"><img src="/deck/images/founder-dimeji.jpg" alt="Dimeji" style="width:100%;height:100%;object-fit:cover;object-position:center;display:block"></div><div><div style="font-size:24px;font-weight:700">Dimeji</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Co-founder</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">From engineering a $1.9bn Nigerian railway to data at Transport for London — with a master's in AI in between.</p><span style="font-size:14px;font-weight:700;color:#EE4643;margin-top:auto">View profile →</span></a>
    <a href="/deck/team/bawo" style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px;text-decoration:none;color:inherit"><div style="width:120px;height:120px;border-radius:50%;background:#FAE8CF;display:flex;align-items:center;justify-content:center;font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:44px;color:#9F6010">B</div><div><div style="font-size:24px;font-weight:700">Bawo Maleghemi</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Co-founder</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">Twelve years in product across fintech, payments and transport — Interswitch, BusRide, Otter — now Conductor.</p><span style="font-size:14px;font-weight:700;color:#EE4643;margin-top:auto">View profile →</span></a>
  </div>
</section>
