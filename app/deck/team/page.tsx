...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 56px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:20px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px"><div style="width:120px;height:120px;border-radius:50%;background:#FAE8CF;display:flex;align-items:center;justify-content:center;font-size:14px;color:#9F6010">Headshot</div><div><div style="font-size:24px;font-weight:700">Wale Shekoni</div><div style="font-size:15px;color:#E88D0E;font-weight:700;margin-top:4px">Founder</div></div><p style="font-size:15px;line-height:1.5;color:#909596;margin:0">One-line bio to be added.</p><a href="#" style="font-size:14px;font-weight:600;color:#E88D0E;text-decoration:none">LinkedIn →</a></div>
...
<section style="max-width:1200px;margin:0 auto;padding:56px 32px 72px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:20px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:16px">
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Enger Teeser</div><div style="font-size:13px;color:#676563">Senior Software Developer</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Victor Achogba</div><div style="font-size:13px;color:#676563">Marketing Manager</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Daniel Olatunji</div><div style="font-size:13px;color:#676563">Operations Manager</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Folashade Adebiyi</div><div style="font-size:13px;color:#676563">Project Manager</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Oluwatoba Ajakaye</div><div style="font-size:13px;color:#676563">Product Designer</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Nnena Elekwa</div><div style="font-size:13px;color:#676563">Project Manager</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Oluwatosin Akinfolarin</div><div style="font-size:13px;color:#676563">Technical Project Manager</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Nyore Ikomoni</div><div style="font-size:13px;color:#676563">Designer</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Oyinlola Akeredolu</div><div style="font-size:13px;color:#676563">Communications</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">AbdulMalik Kolade</div><div style="font-size:13px;color:#676563">Product Design Lead</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Ridwan Adeniyi</div><div style="font-size:13px;color:#676563">Head, Business Development</div></div></div>
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:12px;padding:16px;display:flex;align-items:center;gap:12px"><div style="width:44px;height:44px;border-radius:50%;background:#E6E5E3;flex:none"></div><div><div style="font-size:15px;font-weight:700">Sanusi Sulieiman</div><div style="font-size:13px;color:#676563">Product Development Lead</div></div></div>
  </div>
