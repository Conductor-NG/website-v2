...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 56px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:20px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px"><div style="width:120px;height:120px;border-radius:50%;background:#FAE8CF;display:flex;align-items:center;justify-content:center;font-size:14px;color:#9F6010">Headshot</div><div><div style="font-size:24px;font-weight:700">Wale</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Founder</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">One-line bio to be added.</p><a href="#" style="font-size:14px;font-weight:600;color:#EE4643;text-decoration:none">LinkedIn →</a></div>
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px"><div style="width:120px;height:120px;border-radius:50%;background:#FAE8CF;display:flex;align-items:center;justify-content:center;font-size:14px;color:#9F6010">Headshot</div><div><div style="font-size:24px;font-weight:700">Dimeji</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Co-founder · Chief Technology Officer</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">One-line bio to be added.</p><a href="#" style="font-size:14px;font-weight:600;color:#EE4643;text-decoration:none">LinkedIn →</a></div>
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px"><div style="width:120px;height:120px;border-radius:50%;background:#FAE8CF;display:flex;align-items:center;justify-content:center;font-size:14px;color:#9F6010">Headshot</div><div><div style="font-size:24px;font-weight:700">Bawo</div><div style="font-size:15px;color:#EE4643;font-weight:700;margin-top:4px">Co-founder</div></div><p style="font-size:15px;line-height:1.5;color:#8A7A6B;margin:0">One-line bio to be added.</p><a href="#" style="font-size:14px;font-weight:600;color:#EE4643;text-decoration:none">LinkedIn →</a></div>
  </div>
</section>
...
<section style="background:#fff;border-top:1px solid #ECDFCE;border-bottom:1px solid #ECDFCE">
  <div style="max-width:1200px;margin:0 auto;padding:56px 32px;display:flex;flex-direction:column;gap:20px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
      <div style="background:#FAEDDE;border:1px solid #ECDFCE;border-radius:16px;padding:24px;display:flex;align-items:center;gap:20px"><div style="width:72px;height:72px;border-radius:50%;background:#ECDFCE;flex:none"></div><div><div style="font-size:20px;font-weight:700">Advisor 1</div><div style="font-size:14px;color:#6B5D4E;margin-top:4px">Role · company · credentials pending</div></div></div>
      <div style="background:#FAEDDE;border:1px solid #ECDFCE;border-radius:16px;padding:24px;display:flex;align-items:center;gap:20px"><div style="width:72px;height:72px;border-radius:50%;background:#ECDFCE;flex:none"></div><div><div style="font-size:20px;font-weight:700">Advisor 2</div><div style="font-size:14px;color:#6B5D4E;margin-top:4px">Role · company · credentials pending</div></div></div>
      <div style="background:#FAEDDE;border:1px solid #ECDFCE;border-radius:16px;padding:24px;display:flex;align-items:center;gap:20px"><div style="width:72px;height:72px;border-radius:50%;background:#ECDFCE;flex:none"></div><div><div style="font-size:20px;font-weight:700">Advisor 3</div><div style="font-size:14px;color:#6B5D4E;margin-top:4px">Role · company · credentials pending</div></div></div>
    </div>
  </div>
</section>
