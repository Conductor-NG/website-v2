  ...
  <div style="display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:32px;align-items:stretch">
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
        ...
        <div style="background:#211A14;color:#FFF8F0;border-radius:16px;padding:20px"><div style="font-family:'Instrument Serif',Georgia,serif;font-style:italic;font-size:40px;line-height:1;color:#E98B20">$57</div><div style="font-size:14px;color:#ECDFCE;margin-top:6px">cost per verified car owner</div></div>
      </div>
