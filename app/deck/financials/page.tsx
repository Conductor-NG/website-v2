...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px;position:relative">
  ...
  <div style="display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:32px;align-items:start">
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:hidden;font-size:15px">
      ...
      <div style="display:grid;grid-template-columns:1fr 0.9fr 0.8fr 0.9fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">Dec 2026</strong><span style="text-align:right">700</span><span style="text-align:right">~1,800</span><span style="text-align:right">₦19.8m</span></div>
      <div style="display:grid;grid-template-columns:1fr 0.9fr 0.8fr 0.9fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">June 2027</strong><span style="text-align:right">3,300</span><span style="text-align:right">~8,400</span><span style="text-align:right">₦103.5m</span></div>
      <div style="display:grid;grid-template-columns:1fr 0.9fr 0.8fr 0.9fr;gap:8px;padding:14px 20px;color:#514336"><strong style="color:#211A14">Dec 2027</strong><span style="text-align:right">10,100</span><span style="text-align:right">~25,300</span><span style="text-align:right">₦334.6m</span></div>
    </div>
