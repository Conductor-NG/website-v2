...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 72px;width:100%;box-sizing:border-box;display:grid;grid-template-columns:minmax(0,1.3fr) minmax(0,0.7fr);gap:32px;align-items:start">
  <div style="background:#fff;border:1px solid #E6E5E3;border-radius:16px;overflow:hidden;font-size:15px;line-height:1.35">
    ...
    <div style="display:grid;grid-template-columns:1fr 110px 90px;gap:12px;padding:14px 24px;border-bottom:1px solid #E6E5E3;color:#454442"><span>Deferred compensation — Marketing Advisory Board</span><span style="text-align:right">~₦15m</span><span style="text-align:right">~$10k</span></div>
    ...
    <div style="display:grid;grid-template-columns:1fr 110px 90px;gap:12px;padding:14px 24px;border-bottom:1px solid #E6E5E3;color:#454442"><span>Canada office</span><span style="text-align:right">~₦1.2m</span><span style="text-align:right">~$0.8k</span></div>
...
<section style="background:#fff;border-top:1px solid #E6E5E3;border-bottom:1px solid #E6E5E3">
  <div style="max-width:1200px;margin:0 auto;padding:64px 32px;display:grid;grid-template-columns:minmax(0,0.8fr) minmax(0,1.2fr);gap:40px;align-items:start">
    ...
    <div style="border:1px solid #E6E5E3;border-radius:16px;overflow:hidden;font-size:15px">
      ...
      <div style="display:grid;grid-template-columns:1.3fr 1fr 1fr 1fr;gap:12px;padding:12px 20px;border-bottom:1px solid #E6E5E3;color:#454442"><strong style="color:#292928">Wale Shekoni</strong><span>33 (Jan 2024)</span><span style="text-align:right">£165k</span><span style="text-align:right">~₦317m</span></div>
...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px;position:relative">
  ...
  <div style="display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:32px;align-items:stretch">
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px">
      <div style="display:flex;gap:20px;font-size:14px;color:#454442"><span style="display:flex;align-items:center;gap:8px"><span style="width:14px;height:14px;border-radius:3px;background:#E88D0E;display:inline-block"></span>Revenue ($m)</span><span style="display:flex;align-items:center;gap:8px"><span style="width:14px;height:14px;border-radius:3px;background:#292928;display:inline-block"></span>Net profit ($m)</span></div>
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:24px;height:260px;align-items:end;border-bottom:1px solid #E6E5E3;padding:0 8px">
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">0.30</span><div style="width:100%;height:1%;min-height:3px;background:#E88D0E;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#676563;margin-bottom:4px">0.02</span><div style="width:100%;height:1%;min-height:3px;background:#292928;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">2.61</span><div style="width:100%;height:4%;background:#E88D0E;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#676563;margin-bottom:4px">1.61</span><div style="width:100%;height:2.5%;background:#292928;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">10.58</span><div style="width:100%;height:14%;background:#E88D0E;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#676563;margin-bottom:4px">7.13</span><div style="width:100%;height:9.5%;background:#292928;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">29.62</span><div style="width:100%;height:38%;background:#E88D0E;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#676563;margin-bottom:4px">20.4</span><div style="width:100%;height:26%;background:#292928;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">71.13</span><div style="width:100%;height:90%;background:#E88D0E;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#676563;margin-bottom:4px">49.4</span><div style="width:100%;height:62%;background:#292928;border-radius:4px 4px 0 0"></div></div></div>
      </div>
    ...
    <div style="background:#fff;border:1px solid #E6E5E3;border-radius:16px;overflow:hidden;font-size:15px">
      ...
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #E6E5E3;color:#454442"><strong style="color:#292928">2026</strong><span style="text-align:right">$302k</span><span style="text-align:right">$16k</span><span style="text-align:right">1.69m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #E6E5E3;color:#454442"><strong style="color:#292928">2027</strong><span style="text-align:right">$2.61m</span><span style="text-align:right">$1.61m</span><span style="text-align:right">13.9m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #E6E5E3;color:#454442"><strong style="color:#292928">2028</strong><span style="text-align:right">$10.58m</span><span style="text-align:right">$7.13m</span><span style="text-align:right">54.7m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #E6E5E3;color:#454442"><strong style="color:#292928">2029</strong><span style="text-align:right">$29.62m</span><span style="text-align:right">$20.4m</span><span style="text-align:right">151m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;color:#454442"><strong style="color:#292928">2030</strong><span style="text-align:right">$71.13m</span><span style="text-align:right">$49.4m</span><span style="text-align:right">361m</span></div>
    </div>
  </div>
</section>
