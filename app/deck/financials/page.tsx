...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px;position:relative">
  <div style="display:flex;flex-direction:column;gap:12px;max-width:860px">
    ...
    <h2 style="font-size:36px;font-weight:700;line-height:1.1;letter-spacing:-0.01em;margin:0">$79m revenue by 2030. Break-even in year one.</h2>
  ...
  <div style="display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:32px;align-items:stretch">
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:16px">
      ...
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:24px;height:260px;align-items:end;border-bottom:1px solid #ECDFCE;padding:0 8px">
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">0.3</span><div style="width:100%;height:1%;min-height:3px;background:#E98B20;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#6B5D4E;margin-bottom:4px">0.02</span><div style="width:100%;height:1%;min-height:3px;background:#211A14;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">2.9</span><div style="width:100%;height:4%;background:#E98B20;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#6B5D4E;margin-bottom:4px">1.8</span><div style="width:100%;height:2.5%;background:#211A14;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">11.8</span><div style="width:100%;height:14%;background:#E98B20;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#6B5D4E;margin-bottom:4px">7.9</span><div style="width:100%;height:9.5%;background:#211A14;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">32.9</span><div style="width:100%;height:38%;background:#E98B20;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#6B5D4E;margin-bottom:4px">22.7</span><div style="width:100%;height:26%;background:#211A14;border-radius:4px 4px 0 0"></div></div></div>
        <div style="display:flex;gap:4px;align-items:end;height:100%"><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;font-weight:700;margin-bottom:4px">79.0</span><div style="width:100%;height:90%;background:#E98B20;border-radius:4px 4px 0 0"></div></div><div style="flex:1;display:flex;flex-direction:column;justify-content:end;align-items:center;height:100%"><span style="font-size:13px;color:#6B5D4E;margin-bottom:4px">54.9</span><div style="width:100%;height:62%;background:#211A14;border-radius:4px 4px 0 0"></div></div></div>
      </div>
    ...
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:hidden;font-size:15px">
      ...
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">2026</strong><span style="text-align:right">$336k</span><span style="text-align:right">$17k</span><span style="text-align:right">1.69m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">2027</strong><span style="text-align:right">$2.9m</span><span style="text-align:right">$1.8m</span><span style="text-align:right">13.9m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">2028</strong><span style="text-align:right">$11.8m</span><span style="text-align:right">$7.9m</span><span style="text-align:right">54.7m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;border-bottom:1px solid #ECDFCE;color:#514336"><strong style="color:#211A14">2029</strong><span style="text-align:right">$32.9m</span><span style="text-align:right">$22.7m</span><span style="text-align:right">151m</span></div>
      <div style="display:grid;grid-template-columns:0.7fr 1fr 1fr 0.8fr;gap:8px;padding:14px 20px;color:#514336"><strong style="color:#211A14">2030</strong><span style="text-align:right">$79.0m</span><span style="text-align:right">$54.9m</span><span style="text-align:right">361m</span></div>
    </div>
  </div>
</section>
