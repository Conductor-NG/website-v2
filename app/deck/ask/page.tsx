...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:28px">
  ...
  <div style="display:flex;height:22px;border-radius:8px;overflow:hidden"><div style="width:30%;background:#EE4643"></div><div style="width:27.5%;background:#E98B20"></div><div style="width:15%;background:#211A14"></div><div style="width:10%;background:#9F6010"></div><div style="width:7.5%;background:#6B5D4E"></div><div style="width:5%;background:#D6C3B3"></div><div style="width:5%;background:#ECDFCE"></div></div>
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:hidden;font-size:15px;line-height:1.45">
    ...
    <div style="display:grid;grid-template-columns:20px minmax(160px,0.9fr) 80px 60px minmax(0,1.6fr);gap:16px;padding:14px 24px;border-bottom:1px solid #ECDFCE;align-items:center"><span style="width:16px;height:16px;border-radius:4px;background:#E98B20"></span><strong>Marketing and acquisition</strong><span style="text-align:right">$55k</span><span style="text-align:right">27.5%</span><span style="color:#514336">Scale Google and Meta ads on the proven CPI; launch passenger-side campaigns; drive the Sept–Feb download curve</span></div>
    <div style="display:grid;grid-template-columns:20px minmax(160px,0.9fr) 80px 60px minmax(0,1.6fr);gap:16px;padding:14px 24px;border-bottom:1px solid #ECDFCE;align-items:center"><span style="width:16px;height:16px;border-radius:4px;background:#211A14"></span><strong>Product and infrastructure</strong><span style="text-align:right">$30k</span><span style="text-align:right">15%</span><span style="color:#514336">V2.1 features, safety infrastructure, admin tools, servers, and the Conductor Deliveries launch</span></div>
    ...
    <div style="display:grid;grid-template-columns:20px minmax(160px,0.9fr) 80px 60px minmax(0,1.6fr);gap:16px;padding:14px 24px;border-bottom:1px solid #ECDFCE;align-items:center"><span style="width:16px;height:16px;border-radius:4px;background:#D6C3B3"></span><strong>Advisory retainer (partial cash)</strong><span style="text-align:right">$10k</span><span style="text-align:right">5%</span><span style="color:#514336">Marketing Advisory Board — partial cash for the launch window; balance deferred to Series A or converted to equity</span></div>
