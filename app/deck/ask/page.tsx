  ...
  <div style="max-width:1200px;margin:0 auto;padding:88px 32px;display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:48px;align-items:center">
    <div style="display:flex;flex-direction:column;gap:24px">
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap">
        ...
        <a href="https://conductor.ng" target="_blank" rel="noopener noreferrer" style="display:flex;flex-direction:column;padding:10px 16px;border:1px solid #514336;border-radius:12px;text-decoration:none;color:#FFF8F0;min-width:150px"><span style="font-size:11px;color:#D6C3B3;letter-spacing:0.08em;text-transform:uppercase">Car owner app</span><span style="font-size:15px;font-weight:700">Play Store · App Store</span></a>
      </div>
    </div>
    <img src="/deck/images/anim-driver-passengers.gif" alt="Car owner and passengers" style="width:100%;aspect-ratio:16/10;object-fit:cover;border-radius:24px">
  </div>
</section>
`;
