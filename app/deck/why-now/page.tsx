...
<section style="background:#211A14;color:#FFF8F0">
  <div style="max-width:1200px;margin:0 auto;padding:88px 32px;display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,0.9fr);gap:56px;align-items:center">
    <div style="display:flex;flex-direction:column;gap:24px">
      ...
      <p style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:clamp(28px,3vw,40px);line-height:1.2;margin:0;color:#EE4643">"We wait for the man. The man does not wait for us."</p>
      <p style="font-size:17px;line-height:1.55;margin:0;color:#ECDFCE">That discipline is what made the arrangement work, and it is what makes every carpooling arrangement work everywhere in Nigeria. Conductor is built on that rule. The car owner publishes his trip and commits to the route, the pickup point and the time — and the passenger must be ready when he arrives. If a passenger is not there, the car owner is free to leave without them; the app holds the passenger to that discipline, not the car owner. Every design decision in the product flows from this one principle.</p>
...
<section style="max-width:1200px;margin:0 auto;padding:0 32px 72px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:24px">
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:32px;display:grid;grid-template-columns:80px minmax(0,1fr);gap:24px">
    <div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:56px;line-height:1;color:#EE4643">1</div>
    <div style="display:flex;flex-direction:column;gap:12px">
      <div style="font-size:24px;font-weight:700;line-height:1.2">We flipped the role, and had to teach the flip</div>
      <p style="font-size:16px;line-height:1.55;color:#514336;margin:0">Every Nigerian who has ordered a ride knows the same script: passenger books, driver shows up. That is Uber, Bolt, every ride-hailing app in this market. Conductor flips it — the car owner publishes the trip, the passenger shows up. Just like my mother and the neighbour.</p>
      <p style="font-size:16px;line-height:1.55;color:#514336;margin:0">The MVP failed to teach the flip. Users opened the app expecting Uber and got confused. V1 rebuilds every screen around the model: the car owner's route, the pickup point, the drop-off point, the passenger's responsibility to be ready. The concept is embedded in the UI itself, not left to a tutorial nobody reads. We learned this on our own money, before spending investor money acquiring users who would have churned within minutes.</p>
      <p style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:18px;line-height:1.3;color:#EE4643;margin:0">Learned on our own money, not an investor's.</p>
    </div>
  </div>
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:32px;display:grid;grid-template-columns:80px minmax(0,1fr);gap:24px">
    <div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:56px;line-height:1;color:#EE4643">2</div>
    <div style="display:flex;flex-direction:column;gap:12px">
  ...
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:32px;display:grid;grid-template-columns:80px minmax(0,1fr);gap:24px">
    <div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:56px;line-height:1;color:#EE4643">3</div>
    <div style="display:flex;flex-direction:column;gap:12px">
...
<section style="background:#fff;border-top:1px solid #ECDFCE;border-bottom:1px solid #ECDFCE">
  <div style="max-width:1200px;margin:0 auto;padding:72px 32px;display:flex;flex-direction:column;gap:32px">
    <div style="display:grid;grid-template-columns:80px minmax(0,1fr);gap:24px">
      <div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:56px;line-height:1;color:#EE4643">4</div>
...
<section style="max-width:1200px;margin:0 auto;padding:72px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px">
  ...
  <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;overflow:hidden;font-size:15px;line-height:1.45">
    ...
    <div style="display:grid;grid-template-columns:minmax(160px,0.6fr) minmax(0,1.4fr);gap:20px;padding:14px 24px;border-bottom:1px solid #ECDFCE"><strong>Passenger no-show</strong><span style="color:#514336">Car owner still paid — the settlement router charges NO_SHOW and CANCEL_LATE alongside completed rides</span></div>
    <div style="display:grid;grid-template-columns:minmax(160px,0.6fr) minmax(0,1.4fr);gap:20px;padding:14px 24px;border-bottom:1px solid #ECDFCE"><strong>Car owner no-start</strong><span style="color:#514336">Full refund cascade through per-component escrows; disputes auto-open with GPS evidence</span></div>
    ...
    <div style="display:grid;grid-template-columns:minmax(160px,0.6fr) minmax(0,1.4fr);gap:20px;padding:14px 24px;border-bottom:1px solid #ECDFCE"><strong>Criminal incident</strong><span style="color:#514336">Verified identity means every passenger and car owner is traceable; the banned-identity registry prevents re-entry</span></div>
