...
<section style="background:#292928;color:#FDFAF6">
  <div style="max-width:1200px;margin:0 auto;padding:88px 32px;display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,0.9fr);gap:56px;align-items:center">
    <div style="display:flex;flex-direction:column;gap:24px">
      ...
      <div style="font-size:15px;color:#ACA9A6">Wale Shekoni, Founder</div>
    </div>
...
<section style="background:#fff;border-top:1px solid #E6E5E3;border-bottom:1px solid #E6E5E3">
  <div style="max-width:1200px;margin:0 auto;padding:72px 32px;display:flex;flex-direction:column;gap:32px">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px">
      <div style="border:1px solid #E6E5E3;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px"><div style="display:flex;align-items:center;gap:12px"><span style="width:40px;height:40px;border-radius:10px;background:#FAE8CF;display:inline-flex;align-items:center;justify-content:center;flex:none"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C97810" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M3 10h18"/><path d="M5 10 12 4l7 6"/><path d="M5 10v11"/><path d="M19 10v11"/><path d="M9 14v3"/><path d="M15 14v3"/></svg></span><span style="font-size:18px;font-weight:700">Bank-grade ledger</span></div><p style="font-size:15px;line-height:1.5;color:#454442;margin:0">A double-entry general ledger mirroring the architecture of Temenos T24 — the core banking platform used by major Nigerian commercial banks — and the CBN-approved microfinance platform. Per-user, per-day, per-trip, per-account attribution. Every naira is traceable to its source, holder and destination. The accounting spine of a financial institution, running inside a mobility product.</p></div>
      <div style="border:1px solid #E6E5E3;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px"><div style="display:flex;align-items:center;gap:12px"><span style="width:40px;height:40px;border-radius:10px;background:#FAE8CF;display:inline-flex;align-items:center;justify-content:center;flex:none"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C97810" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="10" width="16" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/><circle cx="12" cy="15" r="1.4"/></svg></span><span style="font-size:18px;font-weight:700">Escrow-based payment mechanics</span></div><p style="font-size:15px;line-height:1.5;color:#454442;margin:0">Passenger money held per trip-day, released to drivers only after service completion, with a 26-hour dispute window. A five-account per-component escrow model — refunds cascade through the correct accounts, not out of a single messy pool.</p></div>
      <div style="border:1px solid #E6E5E3;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px"><div style="display:flex;align-items:center;gap:12px"><span style="width:40px;height:40px;border-radius:10px;background:#FAE8CF;display:inline-flex;align-items:center;justify-content:center;flex:none"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C97810" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"/><path d="M7 21h10"/><path d="M6 6l6-1.5L18 6"/><path d="M3 12l3-6 3 6a3 3 0 0 1-6 0z"/><path d="M15 12l3-6 3 6a3 3 0 0 1-6 0z"/></svg></span><span style="font-size:18px;font-weight:700">GPS-adjudicated dispute engine</span></div><p style="font-size:15px;line-height:1.5;color:#454442;margin:0">Arguments are settled by trip data and roster attendance, not customer-service opinion. Append-only investigation timeline, five-occupant roster, driver, peer and self attestations.</p></div>
      <div style="border:1px solid #E6E5E3;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px"><div style="display:flex;align-items:center;gap:12px"><span style="width:40px;height:40px;border-radius:10px;background:#FAE8CF;display:inline-flex;align-items:center;justify-content:center;flex:none"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C97810" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l3-4 3 3 4-6"/></svg></span><span style="font-size:18px;font-weight:700">Analytics platform and admin console</span></div><p style="font-size:15px;line-height:1.5;color:#454442;margin:0">User panel, ledger viewer, dispute case files, marketer and staff referral leaderboards, KPI dashboards, tracking and automation console. We can run A/B experiments on live users from day one. Most Series A startups do not have this; we have it pre-launch.</p></div>
      <div style="border:1px solid #E6E5E3;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px"><div style="display:flex;align-items:center;gap:12px"><span style="width:40px;height:40px;border-radius:10px;background:#FAE8CF;display:inline-flex;align-items:center;justify-content:center;flex:none"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C97810" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v5c0 4.5-3 7.6-7 9-4-1.4-7-4.5-7-9V6z"/><path d="M9 12l2 2 4-4"/></svg></span><span style="font-size:18px;font-weight:700">Verified identity and banned-identity registry</span></div><p style="font-size:15px;line-height:1.5;color:#454442;margin:0">Bad actors cannot create new accounts and re-enter. Standard on paper, uncommon in practice.</p></div>
