...
<section style="background:linear-gradient(120deg,#E98B20,#EE4643);color:#2E1C03">
  <div style="max-width:1200px;margin:0 auto;padding:72px 32px;display:flex;flex-direction:column;gap:24px">
    ...
    <p style="font-size:24px;font-weight:700;line-height:1.3;margin:0;color:#FFF8F0;max-width:900px;text-wrap:pretty">33 months of founder-funded salaries and a team invested through ownership, so that when we turn it on on September 14, it works the first time.</p>
