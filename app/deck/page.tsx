...
<section style="position:relative;overflow:hidden;border-bottom:1px solid #ECDFCE">
  ...
  <div style="position:relative;max-width:1200px;margin:0 auto;padding:80px 32px 64px;display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:48px;align-items:center">
    <div style="display:flex;flex-direction:column;gap:24px">
      ...
      <p style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:30px;line-height:1.2;color:#EE4643;margin:0">Ride together, share together, save together.</p>
      <p style="font-size:19px;line-height:1.55;color:#514336;margin:0;max-width:600px">Conductor matches car owners with passengers going to the same place. Car owners publish the trip they are already making; passengers book a seat for the week. Paid rides launch on the Lagos Island corridor on 14 September 2026.</p>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      <div style="background:#211A14;color:#FFF8F0;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:48px;line-height:1;color:#EE4643">100</div><div style="font-size:15px;color:#ECDFCE;margin-top:6px">test trips run — plus 20 deliveries piloted</div></div>
      <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:48px;line-height:1">1,000</div><div style="font-size:15px;color:#6B5D4E;margin-top:6px">sign-ups</div></div>
      <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:48px;line-height:1">74%</div><div style="font-size:15px;color:#6B5D4E;margin-top:6px">commute three or more days a week</div></div>
      <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:48px;line-height:1">52%</div><div style="font-size:15px;color:#6B5D4E;margin-top:6px">head to one Lagos Island corridor</div></div>
      <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:48px;line-height:1">~500</div><div style="font-size:15px;color:#6B5D4E;margin-top:6px">car owners onboarded · 100 verified</div></div>
      <div style="background:#211A14;color:#FFF8F0;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:44px;line-height:1;color:#EE4643">Sept 14</div><div style="font-size:15px;color:#ECDFCE;margin-top:6px">paid rides launch</div></div>
    </div>
  </div>
</section>
...
<section style="max-width:1200px;margin:0 auto;padding:80px 32px;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:32px">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:12px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:36px;color:#6B5D4E;line-height:1">Sept 1, 2026</div><div style="font-size:22px;font-weight:700;line-height:1.2">Uber announces exit from Nigeria</div><p style="font-size:17px;line-height:1.5;color:#514336;margin:0">Millions of Nigerian commuters lose their on-demand provider of choice. On-demand hailing could not make Nigerian unit economics work at commuter prices.</p></div>
    <div style="background:#fff;border:1px solid #ECDFCE;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:12px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:36px;color:#6B5D4E;line-height:1">Sept 3, 2026</div><div style="font-size:22px;font-weight:700;line-height:1.2">Shuttlers announces POD</div><p style="font-size:17px;line-height:1.5;color:#514336;margin:0">Announced Sep 3, launching around Sep 25. Pre-booked private small-group rides — premium, fixed-price, manual re-booking. Corporate-shuttle DNA, aimed at a different segment than the daily mass commuter.</p></div>
    <div style="background:#211A14;color:#FFF8F0;border-radius:16px;padding:28px;display:flex;flex-direction:column;gap:12px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:36px;color:#EE4643;line-height:1">Sept 14, 2026</div><div style="font-size:22px;font-weight:700;line-height:1.2">Conductor launches paid rides</div><p style="font-size:17px;line-height:1.5;color:#ECDFCE;margin:0">First paid rides in Lagos after Uber's exit — eleven days ahead of Shuttlers POD. Community carpooling on the Lagos Island corridor. ~500 car owners onboarded, 100 verified and ready today — and climbing as we saturate supply. Supply is already-driving vehicles, so marginal cost per rider is near zero.</p></div>
  </div>
</section>
