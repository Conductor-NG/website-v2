...
<section style="position:relative;overflow:hidden;border-bottom:1px solid #ECDFCE">
  ...
  <div style="position:relative;max-width:1200px;margin:0 auto;padding:80px 32px 64px;display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,0.8fr);gap:48px;align-items:center">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      ...
      <div style="background:#211A14;color:#FFF8F0;border-radius:16px;padding:24px"><div style="font-family:'Instrument Serif','Roboto Flex',Georgia,serif;font-style:italic;font-size:44px;line-height:1;color:#EE4643">Sept 15</div><div style="font-size:15px;color:#ECDFCE;margin-top:6px">paid rides launch</div></div>
    </div>
  </div>
</section>
