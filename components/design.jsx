...
const QGROUPS={
  ...
  agreement:{label:'The agreement',items:[
    ['Why am I asked to show up on time?','Because people ride your trip to get to work or school on a schedule they trust. It is a booked commute, not a hail — if a car does not come, someone is stranded. Showing up on time is the one thing the whole system is built on.'],
    ['Why must I give notice before suspending a day?','So a passenger can find another way in. Ending a day you genuinely cannot run is fine — life happens — but doing it at the last minute leaves people at the roadside. Give reasonable notice and it is treated as the right call, not a breach. It cuts both ways: a passenger who drops out late still pays the car owner, while one who gives notice is refunded.'],
    ...
    ['Why do we run a background check?','Because a passenger is trusting a car owner with their daily safety, and a car owner is trusting who gets into their vehicle. A basic check in both directions is what makes that trust reasonable rather than a leap.'],
    ['Where do I read the full agreement?','The commitments you accept in the app are the binding ones. You can read the full Car Owner Agreement and Code of Conduct any time from your profile, or on this site.']]},
